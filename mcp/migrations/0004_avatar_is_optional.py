...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ModProfile.avatar'
        db.alter_column(u'mcp_modprofile', 'avatar', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'ModProfile.avatar'
        db.alter_column(u'mcp_modprofile', 'avatar', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))
    ...
    models = {
        u'mcp.bulletin': {
            ...
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1408047157'}),
