...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ShardCheckIn', fields ['district']
        db.create_index(u'mcp_shardcheckin', ['district'])

        # Adding index on 'ShardCheckIn', fields ['timestamp']
        db.create_index(u'mcp_shardcheckin', ['timestamp'])


    def backwards(self, orm):
        # Removing index on 'ShardCheckIn', fields ['timestamp']
        db.delete_index(u'mcp_shardcheckin', ['timestamp'])

        # Removing index on 'ShardCheckIn', fields ['district']
        db.delete_index(u'mcp_shardcheckin', ['district'])
    ...
    models = {
        u'mcp.activity': {
            ...
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1408210600'}),
