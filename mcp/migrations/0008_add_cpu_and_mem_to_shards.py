...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShardCheckIn.cpu_usage'
        db.add_column(u'mcp_shardcheckin', 'cpu_usage',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShardCheckIn.mem_usage'
        db.add_column(u'mcp_shardcheckin', 'mem_usage',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=5, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShardCheckIn.cpu_usage'
        db.delete_column(u'mcp_shardcheckin', 'cpu_usage')

        # Deleting field 'ShardCheckIn.mem_usage'
        db.delete_column(u'mcp_shardcheckin', 'mem_usage')
    ...
    models = {
        u'mcp.activity': {
            ...
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1408212207'}),
